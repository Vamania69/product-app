...
export default function Card({ productDetails }) {
  ...
  return (
    ...
    <div id={`${productId}`} className="flex mx-4 md:block text-white rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700  md:min-w-[235px]  md:max-w-[235px]">
      ...
      <div className="px-2 md:px-8 p-2 md:py-6 md:pb-8 bg-gradient-to-b  from-card-primary to-[#3c21771a] rounded-r-lg md:rounded-none md:rounded-b-lg sm:none ">
        <div>
        ...
        <div className="text-base font-semibold items-start line-through"></div>
          <div className="text-lg md:text-3xl font-bold ">{discountedPrice}<span className="text-sm line-through font-normal">  {originalPrice}</span></div>
